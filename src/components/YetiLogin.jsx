...
const YetiLogin = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-[#dceffb] flex flex-col items-center justify-center p-4 font-sans">
      ...
      <div className="relative w-48 h-48 mb-[-35px] z-20">
        <svg viewBox="0 0 200 200" className="w-full h-full drop-shadow-lg">
          ...
          <path d="M70,10 Q100,30 130,10 M60,25 Q100,45 140,25" fill="none" stroke="#d0e0f0" strokeWidth="4" strokeLinecap="round" />

          {/* EARS (Pinkish inside) */}
          <circle cx="20" cy="90" r="18" fill="#fafafa" stroke="#e0e0e0" strokeWidth="2" />
          ...
          <path d="M85,135 Q100,150 115,135" fill="none" stroke="#333" strokeWidth="3" strokeLinecap="round" />

          {/* --- HANDS (THE ANIMATION MAGIC) --- */}
          {/* Increased translate-y value for better coverage */}
          <g 
            className={`transition-transform duration-500 cubic-bezier(0.68, -0.55, 0.27, 1.55) ${isPasswordFocused ? '-translate-y-[85px]' : 'translate-y-[10px]'}`}
          >
            {/* Paws (Thoda fluffy shape) */}
            <path d="M10,180 C0,150 40,140 70,160 C85,170 75,200 40,210 Z" fill="#fafafa" stroke="#e0e0e0" strokeWidth="3" />
            <path d="M190,180 C200,150 160,140 130,160 C115,170 125,200 160,210 Z" fill="#fafafa" stroke="#e0e0e0" strokeWidth="3" />
      ...
      <div className="bg-white/80 backdrop-blur-md p-8 pt-14 rounded-[30px] shadow-2xl w-full max-w-sm text-center relative z-10 border border-white/50">
        ...
        <div className="space-y-5">
          <div className="text-left group">
            ...
            <input 
              ...
              className="w-full mt-1 px-5 py-4 bg-blue-50/50 rounded-2xl border-2 border-transparent focus:bg-white focus:border-blue-400 outline-none transition-all font-medium text-gray-700 placeholder-blue-300"
            />
          </div>
        ...
        <button className="w-full mt-8 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-bold py-4 rounded-2xl shadow-lg shadow-blue-500/40 transition-transform active:scale-[0.98]">
          Let me in!
        </button>
